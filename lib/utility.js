...
function getFooter()
{
    return '<hr><div align="right" class="block"><font size=2.5 color=red><table style="width:100%"><tr><td>&nbsp;</td><td align="right"> <span>powered by&nbsp;&nbsp;&nbsp;</span><img id="helpico" src="image/elastic.png"  width="80" height="25"></td> </tr></table>'
}
